        ...
        "messages": [
            {
                ...
                "content": f"""
                            ...
                            1) Gere exatamente 3 perguntas semanticamente distintas sobre este tema e dificuldade. "Semanticamente distintas" significa que o enunciado não deve ser apenas uma pequena variação do mesmo texto — reescreva e mude o foco quando necessário.
                            2) Para cada uma das 3 perguntas, gere 4 alternativas plausíveis (a,b,c,d) e marque apenas UMA alternativa correta.
                            ...
                            5) NÃO inclua explicações nesse array de 3. Só pergunta e alternativas para o pool.
                            6) Depois de gerar o pool de 3 perguntas, escolha uma delas aleatoriamente e retorne APENAS o objeto JSON da pergunta escolhida, no formato exato abaixo, sem texto adicional, sem quebras de linha no JSON e sem blocos de código:
                            ...
                            REGRAS:
                            - Se alguma das 3 perguntas for muito parecida com outra, reformule até que fiquem distintas.
                            - Para nao repetir perguntas, gere 3 perguntas sobre esse tema com essa dificuldade e faça um sorteio e escolha uma entre essas 3.
